...
PACKAGE ?= helm-grafana-operator
XRD_DIR := apis/grafanaoperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/grafanaoperators/standard.yaml
...
EXAMPLES := \
    examples/grafanaoperators/minimal.yaml:: \
    examples/grafanaoperators/standard.yaml::
...
render\:%:
	@example="examples/grafanaoperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
